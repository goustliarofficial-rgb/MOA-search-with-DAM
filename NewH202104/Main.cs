...
namespace Huangbo.AStarPetri.Test
{
    class MainClass
    {
        ...
        static void Main(string[] args)
        {
            ...
            //string fileName = "Chenfig6changed_333";
            //string fileName = "Chenfig5changed2_55";
            string fileName = "Chen2011Bigchange3_22222";
            //string fileName = "new4x3nobuff_2222";  //The prefix of your input Petri net files.         fileName should be "XXXFigx_111_init.txt" or "XXXFigx_111_matrix.txt".   
            //string fileName = "ChenFig6_333";  //The prefix of your input files. 
